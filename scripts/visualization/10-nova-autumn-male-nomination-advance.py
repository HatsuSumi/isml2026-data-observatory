...
df_voted = df[(df['得票数'] > 0) & (df['是否晋级'] == True)].sort_values(
    '排名',
    ascending=True
)
        ...
        <div class="content-wrapper">
            ...
            <script>
                document.addEventListener('DOMContentLoaded', function() {{
                    ...
                    title.textContent = '01.28-02.23 - 新星组秋季赛提名-男性组别（晋级）';
...
def create_vote_chart():
    try:
        ...
        output_file = os.path.join(output_dir, '10-nova-autumn-male-nomination-advance.html')
